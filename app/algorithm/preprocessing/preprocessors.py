...
from sklearn.preprocessing import QuantileTransformer, MinMaxScaler, OneHotEncoder, StandardScaler, PowerTransformer, label_binarize
...
class XYSplitter(BaseEstimator, TransformerMixin): 
    ...
    def transform(self, data):  
        ...
        return { 'X': X, 'y': y , "ids": data[self.id_col].values, "X_cols": X_cols}
